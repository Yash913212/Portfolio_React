        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-8 text-left">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tighter leading-none">
            ...
            <div className="border border-border/80 rounded-md bg-secondary/20 p-5 font-mono text-[11px] space-y-3.5 shadow-sm">
              <div className="text-[10px] text-muted-foreground uppercase tracking-widest border-b border-border/85 pb-2 font-bold">
                Telemetry Dossier
              </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="glass-card p-8 rounded-md border border-border/80 hover:border-primary/40 card-hover transition-all duration-300 group text-left relative overflow-hidden">
